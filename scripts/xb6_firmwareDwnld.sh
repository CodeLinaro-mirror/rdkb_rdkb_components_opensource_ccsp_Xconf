...
getFirmwareUpgDetail()
{
    ...
    xconf_retry_count=0
    retry_flag=1
    if [ "x$BOX_TYPE" = "xHUB4" ] || [ "x$BOX_TYPE" = "xSR300" ] || [ "x$BOX_TYPE" = "xSR213" ]; then
	...
	echo_t "XCONF SCRIPT : DEVICE MODEL : $devicemodel"
	    ...
	    if [ "$BOX_TYPE" = "HUB4" ] || [ "$BOX_TYPE" = "SR300" ] || [ "$BOX_TYPE" = "SE501" ] || [ "$BOX_TYPE" = "WNXL11BWL" ] || [ "$BOX_TYPE" = "SR213" ]; then #case insensitive option is not working for sed version available in hub4
